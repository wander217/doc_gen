...
lines = []
data_path = r"D:\python_project\doc_gen\gen_by_type\cong_ty_co_phan\pdf_result\cong_ty_co_phan.pdf"
save_path = r'D:\python_project\doc_gen\gen_by_type\cong_ty_co_phan\image_result\1'
...
for page in doc:
    ...
    for line in lines:
        ...
        for item in line:
            tmp.append(item)
        x_min, y_min, x_max, y_max = 10000000, 1000000, 0, 0
        gather_text = []
        for item in tmp:
            x1, y1, x2, y2, t = item
            x_min = min([x_min, x1])
